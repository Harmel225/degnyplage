...
$(".btnHolder5 a").hoverSprite({onLoadWebSite: true});
$(".btnHolder6 a").hoverSprite({onLoadWebSite: true});
$(".btnHolder7 a").hoverSprite({onLoadWebSite: true});
$(".btnHolder8 a").hoverSprite({onLoadWebSite: true});
$(".btnHolder9 a").hoverSprite({onLoadWebSite: true});
$(".btnHolder10 a").hoverSprite({onLoadWebSite: true});
$(".btnHolder11 a").hoverSprite({onLoadWebSite: true});
$(".btnHolder12 a").hoverSprite({onLoadWebSite: true});
...
$('#form1').jqTransform({imgPath:'images/'});
     ...
     $("#jcarousel_5").jCarouselLite({
        btnNext: ".btnHolder5 > .nextBtn",
        btnPrev: ".btnHolder5 > .prevBtn",
        speed: 800,
        visible: 3
    });

     $("#jcarousel_6").jCarouselLite({
        btnNext: ".btnHolder6 > .nextBtn",
        btnPrev: ".btnHolder6 > .prevBtn",
        speed: 800,
        visible: 3
    });

     $("#jcarousel_7").jCarouselLite({
        btnNext: ".btnHolder7 > .nextBtn",
        btnPrev: ".btnHolder7 > .prevBtn",
        speed: 800,
        visible: 3
    });

     $("#jcarousel_8").jCarouselLite({
        btnNext: ".btnHolder8 > .nextBtn",
        btnPrev: ".btnHolder8 > .prevBtn",
        speed: 800,
        visible: 3
    });

     $("#jcarousel_9").jCarouselLite({
        btnNext: ".btnHolder9 > .nextBtn",
        btnPrev: ".btnHolder9 > .prevBtn",
        speed: 800,
        visible: 3
    });

     $("#jcarousel_10").jCarouselLite({
        btnNext: ".btnHolder10 > .nextBtn",
        btnPrev: ".btnHolder10 > .prevBtn",
        speed: 800,
        visible: 3
    });

     $("#jcarousel_11").jCarouselLite({
        btnNext: ".btnHolder11 > .nextBtn",
        btnPrev: ".btnHolder11 > .prevBtn",
        speed: 800,
        visible: 3
    });

     $("#jcarousel_12").jCarouselLite({
        btnNext: ".btnHolder12 > .nextBtn",
        btnPrev: ".btnHolder12 > .prevBtn",
        speed: 800,
        visible: 3
    });
